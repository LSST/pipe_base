...
class _ParserYacc:
    ...
    @classmethod
    def p_expr_identifier(cls, p):
        """expr : identifier"""  # noqa: D403
        p[0] = p[1]

    @classmethod
    def p_identifier_qualified(cls, p):
