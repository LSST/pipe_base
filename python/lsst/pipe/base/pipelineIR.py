...
class PipelineIR:
    ...
    def subset_from_labels(
        ...
        # Don't include expression subsets because we can't generally check
        # their validity; higher-level code (e.g. imports) can restore them.
        pipeline.labeled_expression_subsets.clear()
